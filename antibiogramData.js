...
var PROPERTIES_BY_DRUG =
    {
        ...
        'Cloxacillin/Dicloxacilin': ['Anti-Staphylococcal Penicillin'],
        'Ampicillin/Amoxicillin': ['Amino-Penicillin'],
        'Amoxicillin-Clavulanate': ['Amino-Penicillin'],
        ...
        'Cefadroxil': ['Cephalosporin (PO) Gen 1'],
        'Cephalexin': ['Cephalosporin (PO) Gen 1'],
        'Cefaclor/Loracarbef': ['Cephalosporin (PO) Gen 2'],
        'Cefprozil': ['Cephalosporin (PO) Gen 2'],
        'Cefuroxime': ['Cephalosporin (PO) Gen 2'],
        'Cefixime': ['Cephalosporin (PO) Gen 3'],
        'Ceftibuten': ['Cephalosporin (PO) Gen 3'],
        'Cefpodoxime/Cefdinir/Cefditoren': ['Cephalosporin (PO) Gen 3'],
        ...
        'Trimethoprim': ['Anti-Metabolite'],
        'TMP-SMX': ['Anti-Metabolite'],
...
var PROPERTIES_BY_BUG =
    {
        'Streptococcus Group A,B,C,G': ['Gram Positive'],
        'Streptococcus pneumoniae': ['Gram Positive'],
        'Streptococcus viridans Group': ['Gram Positive'],
        'Streptococcus milleri': ['Gram Positive'],
        'Enterococcus faecalis': ['Gram Positive'],
        'Enterococcus faecium': ['Gram Positive'],
        'Staphylococcus aureus (MSSA)': ['Gram Positive'],
        'Staphylococcus aureus (MRSA)': ['Gram Positive'],
        'Staphylococcus aureus (CA-MRSA)': ['Gram Positive'],
        'Staphylococcus, Coagulase Negative (epidermidis)': ['Gram Positive'],
        'Corynebacterium jeikeium': ['Gram Positive'],
        ...
        'Escheria coli': ['Gram Negative'],
        'Klebsiella': ['Gram Negative'],
        'Escheria coli/Klebsiella ESBL': ['Gram Negative'],
        'Escheria coli/Klebsiella KPC': ['Gram Negative'],
        ...
        'Providencia': ['Gram Negative'],
        'Morganella': ['Gram Negative'],
        'Citrobacter freundii': ['Gram Negative'],
        'Citrobacter diversus': ['Gram Negative'],
        ...
        'Clostridium (not difficile)': ['Anaerobe'],
